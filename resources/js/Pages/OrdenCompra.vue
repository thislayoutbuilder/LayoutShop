                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div>
                        <form style="padding: 2rem;" @submit.prevent="submit">
                            ...
                            <div class="form-control" style="margin-bottom: 2rem;">
                                <label for="supplier" style="margin-bottom: .8rem; font-weight: bold;">Proveedor</label>
                                <select name="supplier" v-model="form.supplierId">
                                    <option v-for="(supplier, i) in allSuppliers" :key="i" :value="supplier.id">{{supplier.name}}</option>
                                </select>
                            </div>
                            <div class="form-control" style="margin-bottom: 2rem;">
                            ...
                            <div class="form-control" style="margin-bottom: 2rem;">
                                <label for="quantity" style="margin-bottom: .8rem; font-weight: bold;">Cantidad</label>
                                <input name="quantity" type="text" v-model="form.qty">
                            </div>
                            <div class="form-control" style="margin-bottom: 2rem;">
                                <label for="driverName" style="margin-bottom: .8rem; font-weight: bold;">Nombre del receptor/conductor</label>
                                <input name="driverName" type="text" v-model="form.driverName">
                            </div>
                            <div class="form-control" style="margin-bottom: 2rem;">
                                <label for="driverDni" style="margin-bottom: .8rem; font-weight: bold;">Cedula del receptor/conductor</label>
                                <input name="driverDni" type="text" v-model="form.driverDni">
                            </div>
                            <div class="form-control" style="margin-bottom: 2rem;">
                                <label for="address" style="margin-bottom: .8rem; font-weight: bold;">Direccion de entrega</label>
                                <input name="address" type="text" v-model="form.address">
                            </div>
                            <div class="form-control" style="margin-bottom: 2rem;">
                                <label for="phone" style="margin-bottom: .8rem; font-weight: bold;">Numero de contacto</label>
